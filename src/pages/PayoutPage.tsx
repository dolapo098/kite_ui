      ...
      <article className="card form-card">
        <form className="auth-form" onSubmit={handleSubmit} noValidate>
          ...
          <label className="field">
            ...
            />
            {errors.amount_in_cents ? <p className="error-text">{errors.amount_in_cents}</p> : null}
          </label>
          ...
          <label className="field">
            ...
            />
            {errors.account_number ? <p className="error-text">{errors.account_number}</p> : null}
          </label>
          ...
          <label className="field">
            ...
            />
            {errors.bank_code ? <p className="error-text">{errors.bank_code}</p> : null}
          </label>
